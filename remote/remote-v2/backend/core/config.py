...
class Config:
    ...
    def _load_config(self) -> None:
        ...
        self.whisper_path = self.project_root / config_data['model'].get('whisper_path', 'models/asr/faster-whisper-large-v3')
        ...
        # 声纹模板存储（Vector DB）
        vector_db_config = storage_config.get('vector_db', storage_config)  # 兼容旧配置
